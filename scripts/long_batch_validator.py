...
def validate_batch(num_files=None):
    """Run MedRec over the long synthetic batch and report metrics."""
    ...
    with open("data/synthetic_long/final_report.json", "w", encoding="utf-8") as f:
        json.dump(report, f, indent=2)
        
    print("\n" + "="*40)
    print("LONG BATCH VALIDATION COMPLETE")
